...
arduino-cli core uninstall "sstuino-ii:megaavr" || true
...
arduino-cli core install "sstuino-ii:megaavr" --additional-urls https://fourierindustries-llp.github.io/SSTuino_II_Core/package_FourierIndustries-LLP_SSTuino_II_Core_index.json
...
arduino-cli compile -b "sstuino-ii:megaavr:4809" ~/Library/Arduino15/packages/sstuino-ii/hardware/megaavr/*.*/libraries/WiFiNINA-SSTuino/examples/Ubidots_5_Demo/Ubidots_5_Demo.ino
